...
<html>
<c:set var="pageTitle" value="Add Design Pattern | Programming Review" scope="request" />
<c:import url="../jsp/header-tag.jsp" />
<body>
<c:import url="../jsp/navigation-bar.jsp" />
<h1>Add Design Pattern</h1>

<form action="/pr/design-patterns/new" method="post" onsubmit="return checkTopicsForm(this);">
